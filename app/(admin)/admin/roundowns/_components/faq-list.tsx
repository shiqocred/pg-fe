...
export const FaqList = ({ items, onReorder, onEdit }: AcaraListProps) => {
              ...
              <Draggable key={acara.id} draggableId={acara.id} index={index}>
                {(provided) => (
                  ...
                  >
                    ...
                    <div className="gap-1 md:px-2 text-xs w-full overflow-hidden text-ellipsis">
                      <p className="font-semibold text-sm w-full line-clamp-2">
                        {acara.question}
                      </p>
                      <p className="line-clamp-2">{acara.answer}</p>
                    </div>
                    <div className="ml-auto pr-2 flex items-center">
                      ...
                      <Button
                        onClick={() => onOpen("delete-faq", acara.id)}
                        className={cn(
