...
export const CardPondok = ({
  ...
  return (
    <Link href={href}>
      <Card className="group w-full gap-3 flex flex-col overflow-hidden rounded-md shadow border p-2 bg-transparent border-gray-300 font-avenir">
        <div className="w-full relatif object-cover aspect-video relative overflow-hidden flex-none rounded">
          <Image
